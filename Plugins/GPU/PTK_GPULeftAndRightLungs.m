classdef PTK_GPULeftAndRightLungs < PTKPlugin
    ...
    properties
        ...
        ToolTip = 'Separate and label left and right lungs with GPU'
        Category = 'GPU'
    ...
    methods (Static)
        function results = RunPlugin(dataset, reporting)
            ...
            elseif strcmp(dataset.GetImageInfo.Modality, 'MR')
                ...
                results = dataset.GetResult('PTK_GPULeftAndRightLungsInitialiser');
            end
        end
    end
end